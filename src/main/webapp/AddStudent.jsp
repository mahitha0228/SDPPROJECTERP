    ...
    <form method="POST" action="/insertstudent">
        <table>
            <tr>
                ...
                <td><input type="text" name="sname" class="form-check-input" required /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="date" name="sdateofbirth" required /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="password" name="spwd" class="form-control" required /></td>
            </tr>
            <tr>
                <td><label>Enter Location</label></td>
                <td><input type="text" name="slocation" class="form-control" required /></td>
            </tr>
            <tr>
                <td><label>Enter Contact</label></td>
                <td><input type="number" name="scontact" class="form-control" required /></td>
            </tr>
            <tr>
                <td><label>Enter Status</label></td>
                <td><input type="text" name="sstatus" class="form-control" required /></td>
            </tr>
            <tr>
