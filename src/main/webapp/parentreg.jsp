...
<h3 align="center">Parent Registration</h3>
<div class="form-container">
    <form method="POST" action="insertparent">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><input type="email" name="pemail" class="form-control" required /></td>
            </tr>
            <tr>
                <td><label>Enter Password</label></td>
                <td><input type="password" name="ppwd" class="form-control" required /></td>
            </tr>
            <tr>
                <td><label>Enter Location</label></td>
                <td><input type="text" name="plocation" class="form-control" required /></td>
            </tr>
            <tr>
                <td><label>Enter Contact</label></td>
                <td><input type="text" name="pcontact" class="form-control" required /></td>
            </tr>
            <tr>
